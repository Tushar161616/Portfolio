...
const Footer = () => {
    ...
    return(
        ...
        <div className="h-[35vh] w-[100vw] bg-[rgb(52,61,104)] flex flex-row justify-around">
   ...
   {/* link section  */}
    ...
    <div className="flex items-center gap-8">
        ...
        <a href="https://leetcode.com/u/sharmatushar0688/" target="_blank" id="Leetcode-icon"><img src="src\assets\leetcode img.png" style= {{height: "35px", width: "35px"}}/></a>
